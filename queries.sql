...
ORDER BY Animal_Highest_Count DESC LIMIT 1; 
  ...
  /*Project 4: Who was the last animal seen by William Tatcher?*/
...
--Project 4: List all vets and their specialties, including vets with no specialties.
  ...
  --Project 4: What animal has the most visits to vets?.
    ...
    --Project 4: Who was Maisy Smith's first visit?
      ...
      --Project 4: How many visits were with a vet that did not specialize in that animal's species?
      ...
      --Project 4: What specialty should Maisy Smith consider getting? Look for the species she gets the most.
